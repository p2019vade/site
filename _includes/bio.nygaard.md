{% include figure image_path="/images/kristen-dahl.png" caption="Figure 1: O Kristen Nygaard μαζί με τον συνεργάτη του Ole-Dahl , δημιούργησαν την γλώσσα προγραμματισμού Simula , 
